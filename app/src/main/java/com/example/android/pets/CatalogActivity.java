...
public class CatalogActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    private final int PET_CURSOR_LOADER_ID = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                ...
                // create intent to launch EditorActivity when a pet in the list is clicked on.
                Intent intent = new Intent(CatalogActivity.this, EditorActivity.class);

                // create specific uri for pet that is clicked on
    ...
    private void insertPet() {
        ...
        Log.v(CatalogActivity.class.getSimpleName(), getString(R.string.successful_insertion));
    ...
    public Loader<Cursor> onCreateLoader(int loaderID, Bundle bundle) {
        ...
        switch (loaderID) {
            case PET_CURSOR_LOADER_ID:
                ...
                cursorLoader = new CursorLoader(getApplicationContext(),PetEntry.CONTENT_URI, projection,
                        null, null, null );
